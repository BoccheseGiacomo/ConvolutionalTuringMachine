...
&\text{- Take the new input } x \text{ and the reward } r \text{ coming from the environment feedback of the previous step or a reward metric derived by interaction with training data} \\
& \\
